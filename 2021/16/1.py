...
def readSubsOfLen(packet):
    remaining = processPacket(packet)
    if len(remaining)>0:
        readSubsOfLen(remaining)
...
def processPacket(packet):
    ...
    if type==4:
        value, remainingPacket = processLiteralValPacket(packet[6:])
    else:
        # print("operator")
