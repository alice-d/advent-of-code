#this is a terrible solution that takes a long time to execute and makes the computer sound like it's dying

def addToPath(path,curr,coord,quant,add):
    #print(curr,coord,quant)
...
for w in range(2):
    ...
    directions = list(wire[w].split(","))
    path=[[0,0]]
    for i in range (0,len(directions)):
        last = path[-1]
        this = [last[0],last[1]]
        direction=directions[i][0]
        quant=int(directions[i][1:])
        if (direction=="R"):
            addToPath(path,this,0,quant,True)
            #this[0]+=quant
        elif (direction=="L"):
            addToPath(path,this,0,quant,False)
            #this[0]-=quant
        elif (direction=="U"):
            addToPath(path,this,1,quant,True)
            #this[1]+=quant
        elif (direction=="D"):
            addToPath(path,this,1,quant,False)
            #this[1]-=quant
        #path.append(this)
    paths.append(path)
 
#this part is slow AF
intersections=[]
for p1 in paths[0]:
    if p1 in paths[1]:
...
#result=446
#[[446, 0], [1003, -28], [662, -28], [662, 350], [-1106, -252], [-367, -605], [-367, -693], [-1139, -1069], [-1526, -1078], [-1913, -351], [-1913, -505], [-1403, -252], [-1004, -148], [-1423, -252], [-1913, -670], [-1767, -252], [-1913, -274], [-2316, -988], [-2380, -1521]]